...
import counters.minter_sdk.Minter.Minter
import counters.minter_sdk.Minter.MinterMatch
import counters.minter_sdk.Minter.TransactionTypes
...
//        var coinChange: counter.minter_sdk.Minter.CoinChange? = null
        ...
        val coinChange = Minter.CoinChange(height, null, type, wallet, sell, coin_to_sell, buy, coin_to_buy)
        return coinChange
    }
}